...
type Props = { isHelper: boolean; onToggle: () => void };

const SwitchRoleRow = ({ isHelper, onToggle }: Props) => (
  <View className="mx-4 mb-3 bg-gray-100 rounded-2xl p-4 flex-row items-center gap-3">
